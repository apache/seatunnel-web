...
public class KingBaseOptionRule {
    ...
    public static final Option<String> URL =
            Options.key("url")
                    ...
                    .withDescription(
                            "jdbc url, eg:"
                                    + "jdbc:kingbase8://localhost:5432/test?useSSL=false&serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8");
    ...
    public static final Option<DRIVER_TYPE> DRIVER =
            Options.key("driver")
                    .enumType(DRIVER_TYPE.class)
                    .defaultValue(DRIVER_TYPE.POSTGRESQL)
                    .withDescription("driver");

    public enum DRIVER_TYPE {
        POSTGRESQL("com.kingbase8.Driver"),
        ;
        private final String driverClassName;

        DRIVER_TYPE(String driverClassName) {
