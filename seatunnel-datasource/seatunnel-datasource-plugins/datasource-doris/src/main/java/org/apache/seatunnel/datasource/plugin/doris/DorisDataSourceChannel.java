...
public class DorisDataSourceChannel implements DataSourceChannel {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DorisDataSourceChannel.class);
    ...
    public List<String> getTables(
        ...
        DorisCatalog catalog = getCatalog(requestParams);
    ...
    public boolean checkDataSourceConnectivity(
        ...
        try {
            DorisCatalog catalog = getCatalog(requestParams);
            String nodeUrls = requestParams.get(DorisOptionRule.NODE_URLS.key());
            LOGGER.warn("nodeUrls: {}", nodeUrls);
            ...
            throw new DataSourcePluginException(
                    "check Apache Doris connectivity failed, " + e.getMessage(), e);
        }
    }
    ...
    private DorisCatalog getCatalog(Map<String, String> requestParams) {
        try {
            ...
            String jdbc = requestParams.get(DorisOptionRule.BASE_URL.key());
            return new DorisCatalog("Doris", username, password, jdbc);
        } catch (Exception e) {
