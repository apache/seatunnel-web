...
import type { ITaskTypeItem, TaskType } from '@/store/project/types'
...
interface IResponseJsonItem extends Omit<IJsonItemParams, 'type' | 'name'> {
...
interface IOtherParams {
  dependStrategy?: 'failure-continue' | 'failure-waiting'
}
...
interface ITaskParams {
  ...
  informaticaFolderName?: string | null
  informaticaWorkflowName?: string | null
}
