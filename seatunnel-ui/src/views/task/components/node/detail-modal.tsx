...
import { defineComponent, PropType, ref, watch, nextTick, h, Ref } from 'vue'
...
import { useTaskNodeStore, TASK_TYPES_MAP } from '@/store/project'
import type {
  ITaskData,
  ITaskType,
    ...
    return () => (
      ...
      >
        <Detail
          ...
          definitionRef={props.definition}
        />
      </Modal>
    )
  }
